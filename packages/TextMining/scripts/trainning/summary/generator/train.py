...
logging.info('trainingSet cardinality: ' + str(tf.data.experimental.cardinality(trainingSet).numpy()))
logging.info('validationSet cardinality: ' + str(tf.data.experimental.cardinality(validationSet).numpy()))
